...
public class ResourceCentreTest {
	...
	public void testDoLoanCamcorder() {
		...
		assertEquals("Test if the Camcorder arraylist is reduce by 1?", -1, camcorderList.size());
		
		ResourceCentre.doLoanCamcorder(camcorderList, cc1.getAssetTag(), cc1.getDueDate());
		assertFalse(cc1.getIsAvailable());
		
		ResourceCentre.doLoanCamcorder(camcorderList, cc1.getAssetTag(), cc1.getDueDate());
		assertFalse(camcorderList.contains(cc1));
		
		ResourceCentre.doLoanCamcorder(camcorderList, cc2.getAssetTag(), cc2.getDueDate());
		assertEquals("Test if the Camcorder arraylist is reduce by 1?", -1, camcorderList.size());
		...
		ResourceCentre.doLoanCamcorder(camcorderList, cc2.getAssetTag(), cc2.getDueDate());
		assertFalse(camcorderList.contains(cc2));
	...
	public void testDoLoanChromebook() {
		...
		assertEquals("Test if the Chromebook arraylist is reduce by 1?", -1, chromebookList.size());

		ResourceCentre.doLoanChromebook(chromebookList, cb1.getAssetTag(), cb1.getDueDate());
		assertFalse(cb1.getIsAvailable());

		ResourceCentre.doLoanChromebook(chromebookList, cb1.getAssetTag(), cb1.getDueDate());
		assertFalse(chromebookList.contains(cb1));

		ResourceCentre.doLoanChromebook(chromebookList, cb2.getAssetTag(), cb2.getDueDate());
		assertEquals("Test if the Chromebook arraylist is reduce by 1?", -1, chromebookList.size());
		...
		ResourceCentre.doLoanChromebook(chromebookList, cb2.getAssetTag(), cb2.getDueDate());
		assertFalse(chromebookList.contains(cb2));
